...
| --- | --- | --- |
| `index-example.md` | Folder index | How a folder describes its own contents and links every note in it. Index notes are exempt from the orphan rule, which is why they can afford to be pure hubs. |
